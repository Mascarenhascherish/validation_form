document.addEventListener('DOMContentLoaded',()=>{
    ...
    email.addEventListener('input',()=>{
        if(email.validity.valid){
            ...
            emailFeedback.textContent='Please ener a valid email address';
       ...
       password.addEventListener('input',()=>{
        if (password.value.length>=8){
          ...
          passwordFeedback.textContent='Password must be at least 8 charcters long';
       ...
       username.addEventListener('input',()=>{
         if(username.value.length>=5){
            ...
            usernameFeedback.textContent='Username must be atlset 3 characters long';
